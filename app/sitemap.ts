...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    { url: "https://rudrasankha.com", lastModified: new Date(), changeFrequency: 'daily', priority: 0.8 },
    { url: "https://rudrasankha.com/Resume.pdf", lastModified: new Date(), changeFrequency: 'daily', priority: 0.8 },
    { url: "https://rudrasankha.com/projects", lastModified: new Date(), changeFrequency: 'daily', priority: 0.8 },
